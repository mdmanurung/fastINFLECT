...
#' \code{\link{Lfunction}} to determine the inflection point for optimal k. This
#' keeps the original INFLECT curve-fitting interpretation while allowing the
#' score curve to be generated by the faster fastINFLECT engine.
#'
