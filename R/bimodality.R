...
#' flag heavy-tailed or strongly skewed but genuinely unimodal markers (common in
#' cytometry) as bimodal. Use it to rank markers/clusters for follow-up, and
#' confirm with the dip test.
#'
